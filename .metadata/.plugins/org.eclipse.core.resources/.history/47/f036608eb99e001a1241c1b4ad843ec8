...
ErrorStatus SCHEDULAR_Init(void)
{
	...
	for(Local_u32ForLoopCounter = 0;Local_u32ForLoopCounter < NUMBER_OF_TASKS;Local_u32ForLoopCounter++)
	{
...
static ErrorStatus SCHEDULAR_Schedular(void)
{
	...
	for(Local_u8ForLoopCounter=0;Local_u8ForLoopCounter < NUMBER_OF_TASKS;Local_u8ForLoopCounter++)
	{
